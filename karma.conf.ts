  ...
  config.set({
    ...
    karmaTypescriptConfig: {
      ...
      bundlerOptions: {
        resolve: {
          alias: {
            '@camunda8/spectral-test-utils': require.resolve('./test-utils/browser/index.js'),
            '@camunda8/spectral-test-utils/matchers': path.join(__dirname, './test-utils/matchers.ts'),
