...
export default (input) => {
  if (upperCase(input) !== input) {
    return [{ message: 'must be upper case' }];
        ...
        '/p/.spectral/lower-case.mjs': `import lowerCase from 'https://esm.sh/lodash.lowercase';
...
export default {
  rules: {
    ...
    'lower-case-rule': {
      ...
      expect(code).toEqual(`import lowerCase$1 from 'https://esm.sh/lodash.lowercase';
import upperCase$1 from 'https://esm.sh/lodash.uppercase';
