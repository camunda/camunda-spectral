...
`);
  ...
  it('should respect ignore list', async () => {
    serveAssets({
      '/tmp/input.js': `import { createRulesetFunction } from '@camunda8/spectral-core/ruleset/validation';
...
`,
    ...
    expect(code).toEqual(`import { createRulesetFunction } from '@camunda8/spectral-core/ruleset/validation';
