...
import { serveAssets, mockResponses } from '@camunda8/spectral-test-utils';
 ...
 *   ▶️ Normal: https://esm.sh/pin/lodash@v4.17.21-K6GEbP02mWFnLA45zAmi/mode=imports/optimized/lodash.js
 *   ⏩ Minified: https://esm.sh/pin/lodash@v4.17.21-K6GEbP02mWFnLA45zAmi/mode=imports,min/optimized/lodash.js
 *
 */
...
export {default} from '/-/lodash@v4.17.21-K6GEbP02mWFnLA45zAmi/dist=es2020,mode=imports/optimized/lodash.js';`,
      'https://esm.sh/-/lodash@v4.17.21-K6GEbP02mWFnLA45zAmi/dist=es2020,mode=imports/optimized/lodash.js': `export function upperCase() {}
