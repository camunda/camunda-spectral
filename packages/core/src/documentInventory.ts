...
import { Resolver, ResolveResult } from '@camunda8/spectral-ref-resolver';
...
import { getClosestJsonPath, isAbsoluteRef, traverseObjUntilRef } from '@camunda8/spectral-runtime';
